...
| 15-18h | **Determinants** | Little groups |  
...
Of target individual.

<div class="example-list">

1. For example, when the target behavior is "hand washing", valid sub-behaviors / performance objectives are:
...
Product: list of all potentially relevant environmental conditions and environmental agents.

<div class="example-list">

1. Handwashing:
  1. Soap needs to be there; Employer controls this.

2. Condom use in gay sauna:
  1. gotta have condoms, lube, etc
...
2. gay sauna owner, safe sex: expectation that more customers will come when free lube is provided, etc - potential false belief: with free lube, people will slip and die.
