...
```{r logic-model-of-behavior, fig.caption = "Logic Model of Behavior", echo=FALSE}
...
# logicModelOfBehavior_targetBehavior_health <-
#   logicModelOfBehavior_targetBehavior$clone();
# logicModelOfBehavior_targetBehavior_health$name <-
#   "At-Risk Population Behavior";
# tmpNode_healthOutcomes$AddChildNode(logicModelOfBehavior_targetBehavior_health);
...
logicModelOfBehavior <-
  data.tree::Node$new("Quality Of Life");
data.tree::SetNodeStyle(logicModelOfBehavior, 
...
data.tree::SetNodeStyle(logicModelOfBehavior_targetBehavior, 
...
logicModelOfBehavior_graph <-
  data.tree::ToDiagrammeRGraph(logicModelOfBehavior);
logicModelOfBehavior_graph <-
  apply_graph_theme(
    logicModelOfBehavior_graph,
    c("layout", "dot", "graph"),
...
#DiagrammeR::render_graph(logicModelOfBehavior_graph);

DiagrammeR::export_graph(
  logicModelOfBehavior_graph,
  file_name = "img/140---logic-model-of-behavior.png",
  width = 1800
)

```

![Logic model of Behavior](img/140---logic-model-of-behavior.png)


<!----------------------------------------------------------------------------->
<!----------------------------------------------------------------------------->
<!----------------------------------------------------------------------------->
<!-- Dit stukje hieronder is het oude stukje. Wat het onduidelijk maakt voor mij, is dat daaronder weer staat dat iets HEEL belangrijk is. Niet oud en niet weg doen, dus? ik heb wat gemixt met hierboven. --------------------------------->
<!----------------------------------------------------------------------------->
<!----------------------------------------------------------------------------->
<!----------------------------------------------------------------------------->
