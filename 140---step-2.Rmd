...
To identify the performance objectives for health promoting behaviors, ask yourself the following question: "What do the people *have to do* to perform the health-related behavior?" 

Formulate performance objectives in a way that makes them measurable and that describes action. Do not formulate performance objectives as determinants: "X should be able to do Y". That is not a performance objective; a performance objective should be: "X does Y".
