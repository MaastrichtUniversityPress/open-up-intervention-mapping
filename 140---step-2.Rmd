...
Second, you define the target behavior. This is _*the desirable behavior*_ of the target group: what should they do exactly?


### List environmental conditions

Third, list the environmental conditions you want to realise. Similar to the target behavior, this should be the _*desirable state*_. 
