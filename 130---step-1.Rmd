...
We want to increase physical activity in young children, and decrease overweight. 
- Members of the at-risk group are important participants in a planning group, but here we would ask one or two parents.
- an example of a decision maker would be the ...
- The head of schools are important implementers, so we would invite them.
- Experts in physical exercise and obesity
- etc
