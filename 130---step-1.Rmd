...
In the 4th edition of the Intervention Mapping textbook, step 1 is discussed in Chapter 4, where the following learning objectives and tasks are discussed:
...
In this chapter of the workbook, we will do the same work. However, in the following exercises, we deviate from the structure in the book by splitting up each task into subtasks, which makes it all easier.

In the online version of this workbook, we use boxes with different colours to clearly signal types of content:
