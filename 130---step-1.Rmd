...
When we say 'brainstorm', we mean that you have to try to address all aspects of the problem. Usually, you ask 'what-where-why-who-for whom' questions to get to the bottom of the problem. We help you out for your first 'brainstorm' with the following questions you should address. Make notes in your google doc of the answers:
...
1. In an intervention to promote social distancing in Amsterdam, we want to target the older population
