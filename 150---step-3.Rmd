...
The change objectives in each of your Matrices of Change Objectives correspond to the sub-determinants in column D of your ABCD matrix. The change objectives describe what you will target (and thus what you expect to change) for each targeted population (i.e., your target group, your environmental agent(s), etc).
...
As you will see in the 2 examples, not every ABCD matrix looks the same. So, do not immediately think you did something wrong if it is not entirely similar to the examples. 

- Link to 2 ABCD's unrelated to sex. 
...
-  This is really the moment to be creative together! Of course you could find themes on the internet of well-known interventions, which  might inspire you, or first seeing other examples might be creativity-crippling and turn you into a copy-cat. 
